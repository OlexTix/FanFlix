      ...
      <div class="card">
        <div class="field">
          <Field name="email" v-slot="{ field, errorMessage }">
            <InputText v-bind="field" placeholder="E-mail" aria-describedby="email-help"
        ...
        <div class="field">
          <Field name="confirmemail" v-slot="{ field, errorMessage }">
            <InputText v-bind="field" placeholder="Confirm E-mail" aria-describedby="email-help"
              :class="{ 'p-invalid': errorMessage }" />
            <small id="email-help" class="p-error">{{ errorMessage }}</small>
          </Field>
        </div>
        ...
        <div class="field">
          <Field name="name" v-slot="{ field, errorMessage }">
            <InputText v-bind="field" placeholder="Name" aria-describedby="email-help"
              :class="{ 'p-invalid': errorMessage }" />
            <small id="email-help" class="p-error">{{ errorMessage }}</small>
          </Field>
        </div>
        <div class="field">
          <Field name="lastname" v-slot="{ field, errorMessage }">
            <InputText v-bind="field" placeholder="Lastname" aria-describedby="email-help"
              :class="{ 'p-invalid': errorMessage }" />
            <small id="email-help" class="p-error">{{ errorMessage }}</small>
          </Field>
        </div>
        ...
        <div class="field">
          <Field name="phonenumber" v-slot="{ field, errorMessage }" v-model.number="phonenumber" type="number">
            <InputText v-bind="field" placeholder="Phone number" aria-describedby="email-help"
              :class="{ 'p-invalid': errorMessage }" />
            <small id="email-help" class="p-error">{{ errorMessage }}</small>
          </Field>
        </div>
